...
| primary_variable      | The primary independent variable of interest.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Yes       | No change                                                                                                                                                                            |
| fdr_method            | Your choice of method for adjusting p-values. Options are BY   (default), BH, or bonferroni. Adjustment is computed for all initial, single   variable, associations across all dependent features.                                                                                                                                                                                                                                                                                                                                                        | No        | No change                                                                                                                                                                            |
| fdr_cutoff            | Cutoff for an FDR significant association. All features with   adjusted p-values initially under this value will be selected for vibrations.   (default = 0.05). Setting a stringent FDR cutoff is mostly relevant when you   are using a large number of dependent variables (eg >50) and want to   filter those with weak initial associations.                                                                                                                                                                                                          | No        | No change                                                                                                                                                                            |
| proportion_cutoff     | A float between 0 and 1. Setting this filters out dependent   features that are this proportion of zeros or more (default = 1, so no   filtering will be done.)                                                                                                                                                                                                                                                                                                                                                                                            | No        | No change                                                                                                                                                                            |
| vibrate               | TRUE/FALSE -- run vibrations (default = TRUE).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | No        | No change                                                                                                                                                                            |
| max_vars_in_model     | Maximum number of variables allowed in a single fit in vibrations.   In case an individual has many hundreds of metadata features, this prevents   models from being fit with excessive numbers of variables. Setting this   parameter will improve runtime for large datasets. (default=NULL)                                                                                                                                                                                                                                                             | No        | No change                                                                                                                                                                            |
| max_vibration_num     | Maximum number of vibrations allowed for a single dependent   variable. Setting this will also reduce runtime by reducing the number of   models fit. (default = 10,000)                                                                                                                                                                                                                                                                                                                                                                                   | No        | No change                                                                                                                                                                            |
| meta_analysis         | TRUE/FALSE -- indicates if computing meta-analysis across multiple   datasets. Set to TRUE by default if the pipeline detects multiple datasets.   Setting this variable to TRUE but providing one dataset will throw an error.                                                                                                                                                                                                                                                                                                                            | No        | No change                                                                                                                                                                            |
| model_type            | Specifies regression type -- "glm", "survey",   or "negative_binomial". Survey regression will require additional   parameters (at least weight, nest, strata, and ids). Any model family (e.g.   gaussian()), or any other parameter can be passed as the family argument to   this function.                                                                                                                                                                                                                                                             | No        | No change                                                                                                                                                                            |
| family                | GLM family (default = gaussian()). For help see help(glm) or   help(family).                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | No        | No change                                                                                                                                                                            |
| ids                   | Name of column in dataframe specifying cluster ids from largest   level to smallest level. Only relevant for survey data. (Default = NULL).]                                                                                                                                                                                                                                                                                                                                                                                                               | No        | No change                                                                                                                                                                            |
| strata                | Name of column in dataframe with strata. Relevant for survey data.   (Default = NULL).                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | No        | No change                                                                                                                                                                            |
| weights               | Name of column containing sampling weights.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | No        | No change                                                                                                                                                                            |
| nest                  | If TRUE, relabel cluster ids to enforce nesting within strata.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | No        | No change                                                                                                                                                                            |
| cores                 | Number of cores to use for vibration (default = 1).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | No        | No change                                                                                                                                                                            |
| confounder_analysis   | TRUE/FALSE -- run mixed effect confounder analysis (default=TRUE).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | No        | No change                                                                                                                                                                            |
## Usage (R terminal)
